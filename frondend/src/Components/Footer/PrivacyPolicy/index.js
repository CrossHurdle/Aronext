...
import "../../Css/Footer/PrivacyPolicy.scss";
      ...
      <div className="PrivacyMain">
        <Card className="PrivacyCard">
          ...
          <p className="PrivacyPara">
            Szigony technologies built the Nagpurbazaar web and app. This
            SERVICE is provided by Szigony technologies and is intended for use
            ...
            our Terms and Conditions, which is accessible at Nagpurbazaar unless
          ...
          <p className="PrivacyPara">
            ...
            including but not limited to access to the internet, access to
            files, device info, access to location, access to camera.The
          ...
          <p> This policy is effective as of 2020-12-29</p>
          <h2> Contact Us</h2>
          <p className="PrivacyPara">
            {" "}
