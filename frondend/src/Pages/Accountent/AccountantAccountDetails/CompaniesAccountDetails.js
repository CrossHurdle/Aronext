    ...
    <div>
      <form onSubmit={handleSubmit(handleFormSubmit)}>
        <div className="personal-informations p-4">
          <div className="pages-title mb-3">Companies Account Details</div>
          <Row className="mb-3">
            ...
            <Col sm={24} md={8} className="Stud-personal-col p-2">
              <label className="input-title">Company Email Id </label>
              <input
                className="input-field"
            ...
            <Col sm={24} md={8} className="Stud-personal-col p-2">
              <label className="input-title">Account Number </label>
              <input
                className="input-field"
