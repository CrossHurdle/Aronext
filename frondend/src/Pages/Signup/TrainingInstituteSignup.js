...
//     { label: "Affiliated-Institute", value: "affiliated" },
//     { label: "University", value: "University" },
//     { label: "Deemed-University", value: "DeemedUniversity" },
//     { label: "School", value: "School" },
//     { label: "Training Institute", value: "trainingInstitute" },
//   ];
//   const rangeSelector = [
...
//     const userDetails = {
//       role: "institute",
//       instituteName: getValues().instituteName,
//       instituteType: getValues().instituteType,
...
//     await Api.post(`institute/institute_create`, userDetails)
//       .then((res) => {
//         setResres({
...
//                         md={6}
//                       >
//                         <label className="mb-1">Institute Name</label>
//                         <input
//                           className="input"
...
//                         <label className="mb-1">Institute Website</label>
//                         <input
//                           name="instituteType"
//                           className="input1"
